...
CREATE TABLE `factura` (
  ...
  `carrito_id` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `carrito_id` (`carrito_id`),
  CONSTRAINT `factura_ibfk_1` FOREIGN KEY (`carrito_id`) REFERENCES `carrito` (`id`),
  CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`carrito_id`) REFERENCES `carrito` (`id`)
